...
public final class OmniSciDBSessionProperties
        implements SessionPropertiesProvider
{
    ...
    @Inject
    public OmniSciDBSessionProperties(OmniSciDBConfig omniSciDBConfig)
    {
        sessionProperties = ImmutableList.of(
                enumProperty(
                        ARRAY_MAPPING,
                        "Handling of OmniSciDB arrays",
                        ArrayMapping.class,
                        omniSciDBConfig.getArrayMapping(),
                        false));
    }
